...
export class AccountEndpoint extends EndpointFactory {
    ...
    getUserEndpoint<T>(userId?: string): Observable<any> {
    ...
    getUserByUserNameEndpoint<T>(userName: string): Observable<any> {
    ...
    getUsersEndpoint<T>(page?: number, pageSize?: number): Observable<any> {
    ...
    getNewUserEndpoint<T>(userObject: any): Observable<any> {
    ...
    getUpdateUserEndpoint<T>(userObject: any, userId?: string): Observable<any> {
        let endpointUrl = userId ? `${this.usersUrl}/${userId}` : this.currentUserUrl;
    ...
    getPatchUpdateUserEndpoint<T>(patch: {}, userId?: string): Observable<any>
    getPatchUpdateUserEndpoint<T>(value: any, op: string, path: string, from?: any, userId?: string): Observable<any>
    getPatchUpdateUserEndpoint<T>(valueOrPatch: any, opOrUserId?: string, path?: string, from?: any, userId?: string): Observable<any> {
    ...
    getUserPreferencesEndpoint<T>(): Observable<any> {
    ...
    getUpdateUserPreferencesEndpoint<T>(configuration: string): Observable<any> {
    ...
    getUnblockUserEndpoint<T>(userId: string): Observable<any> {
    ...
    getDeleteUserEndpoint<T>(userId: string): Observable<any> {
    ...
    getRoleEndpoint<T>(roleId: string): Observable<any> {
    ...
    getRoleByRoleNameEndpoint<T>(roleName: string): Observable<any> {
    ...
    getRolesEndpoint<T>(page?: number, pageSize?: number): Observable<any> {
    ...
    getNewRoleEndpoint<T>(roleObject: any): Observable<any> {
    ...
    getUpdateRoleEndpoint<T>(roleObject: any, roleId: string): Observable<any> {
        let endpointUrl = `${this.rolesUrl}/${roleId}`;
    ...
    getDeleteRoleEndpoint<T>(roleId: string): Observable<any> {
        let endpointUrl = `${this.rolesUrl}/${roleId}`;
